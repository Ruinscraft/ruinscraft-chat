...
public abstract class Message {
    ...
    public void show(ChatPlugin chatPlugin, Player to) {
        ...
        if (FilterUtil.isBadMessage(chatPlugin.getRacialSlurs(), content)) {
            return;
        }
    ...
    public abstract void showChatSpy(ChatPlugin chatPlugin, Player staff);

    public abstract void showConsole(ChatPlugin chatPlugin);
